...
# log of changes since last share (1/27) to 2/12/2023:
...
problem_list_rows <- c("6-methylchrysene", "anthracene", "benzo[a]fluorene", "benzo[a]pyrene", "benzo[b]fluorene", "benzo[ghi]perylene", "benzo[j]fluoranthene", "benzo[k]fluoranthene", "coronene", "cyclopenta[cd]pyrene", "indeno[1,2,3-cd]pyrene", "perylene")
...
ggplot(CV_cheminfo, aes(x = CV, y = reorder(Name, MW))) +
  geom_point() + 
    geom_vline(xintercept = 100) +
  labs(x = "Coefficient of Variation (%)", y = NULL) +
  theme_bw()
...
ggplot(CV_cheminfo, aes(x = CV, y = reorder(Name, MW))) +
  geom_point(aes(size = ALL_CV$Rings)) + 
    geom_vline(xintercept = 100) +
  labs(x = "Coefficient of Variation (%)", y = NULL) +
  theme_bw()

#relationship between koa (octanol, air partitioning coefficient) and CV
ggplot(CV_cheminfo, aes(x = CV, y = reorder(Name, `log Koa`))) +
  geom_point() + 
    geom_vline(xintercept = 100) +
  labs(x = "Coefficient of Variation (%)", y = NULL) +
  theme_bw()
